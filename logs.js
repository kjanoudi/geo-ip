...
var endpoint = "vpc-cheddar-logging-ebyqdwbd2xobhidortzliqcb34.us-east-1.es.amazonaws.com";
  ...
  var request = https
    .request(requestParams, function(response) {
      ...
      response.on("end", function() {
        ...
        var error =
          response.statusCode !== 200 || info.errors === true
            ? {
...
function buildRequest(endpoint, body) {
  ...
  var canonicalString = [request.method, request.path, "", canonicalHeaders, "", signedHeaders, hash(request.body, "hex")].join("\n");
